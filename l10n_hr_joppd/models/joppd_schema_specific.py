class JoppdSchema(object):
    ...
    def xmldata_strana_B(self):
        ...
        left join l10n_hr_joppd_codebook c_b2 on c_b2.id = B.b2_id
        left join l10n_hr_joppd_codebook c_b3 on c_b3.id = B.b3_id
        left join l10n_hr_joppd_codebook c_b61 on c_b61.id = B.b61_id
        left join l10n_hr_joppd_codebook c_b62 on c_b62.id = B.b62_id
        left join l10n_hr_joppd_codebook c_b151 on c_b151.id = B.b151_id
        left join l10n_hr_joppd_codebook c_b161 on c_b161.id = B.b161_id
        WHERE joppd_id = %s
        ORDER BY B.b1
        """
        return sql
    ...
    def xml_naslov(self):
        return "Izvješće o primicima, porezu na dohodak i prirezu te doprinosima za obvezna osiguranja"
...
class JoppdSchemaV10(JoppdSchema):
    ...
    def __init__(self):
        ...
        self.namespace = (
            "http://e-porezna.porezna-uprava.hr/sheme/zahtjevi/ObrazacJOPPD/v1-0"
        )
    ...
    def oznaka_selection(self):
        popis_oznaka_prilog1 = [
            ...
            (
                "3",
                "3 - Poslodavci diplomatske misije i konzularni uredi stranih država i međunarodnih organizacija",
            ),
            ...
            (
                "10",
                "10 - Platni agent - kada isplaćuje dividendu dioničarima fizičkim osobama ",
            ),
            ("11", "11 - Poslodavac u stečaju - u slučaju izravne isplate plaće"),
            (
                "12",
                "12 - Osiguranik po osnovi rada kod poslodavca u drugoj državi članici Europske unije",
            ),
            (
                "13",
    ...
    def stavke_strana_A(self):
        return [
            ...
            (
                "V.3",
                "Ukupan iznos predujma poreza na dohodak i prireza porezu na dohodak po osnovi dohotka od imovinskih prava",
            ),
            (
                "V.4",
            ...
            (
                "VI.3.2",
                "Ukupan iznos doprinosa za zaštitu zdravlja na radu po osnovi radnog odnosa",
            ),
            (
                "VI.3.3",
                "Ukupan iznos doprinosa za zdravstveno osiguranje po osnovi poduzetničke plaće",
            ),
            (
                "VI.3.4",
                "Ukupan iznos doprinosa za zaštitu zdravlja na radu po osnovi poduzetničke plaće",
            ),
            (
                "VI.3.5",
    ...
    def sql_sum_B_to_A(self):
        ...
        FROM (SELECT
                  to_number(cb61.code, text(9999)) as b61n,
                  to_number(cb62.code, text(9999)) as b62n,
            ...
            FROM l10n_hr_joppd_b as B
            left join l10n_hr_joppd_codebook cb61 on cb61.id = B.b61_id
            left join l10n_hr_joppd_codebook cb62 on cb62.id = B.b62_id
    ...
    def xml_strana_A(self, EM, a):
        xml = EM.StranaA(
            ...
            EM.NaknadaZaposljavanjeInvalida(
                ...
                EM.IzvjesceSastavio(
                    EM.Ime(a["sast_ime"]), EM.Prezime(a["sast_prezime"])
                ),
            ),
        )
        return xml
...
class JoppdSchemaV11(JoppdSchema):
    ...
    def __init__(self):
        ...
        self.namespace = (
            "http://e-porezna.porezna-uprava.hr/sheme/zahtjevi/ObrazacJOPPD/v1-1"
        )
    ...
    def xml_strana_A(self, EM, a):
        ...
        xml = EM.StranaA(
            ...
            EM.IzvjesceSastavio(EM.Ime(a["sast_ime"]), EM.Prezime(a["sast_prezime"])),
        )
        return xml
